...
```bash [npm]
npx @galaxy-stack/design-cli@latest add date-time-picker
```

```bash [pnpm]
pnpm dlx @galaxy-stack/design-cli@latest add date-time-picker
```

```bash [yarn]
yarn dlx @galaxy-stack/design-cli@latest add date-time-picker
```

```bash [bun]
bunx @galaxy-stack/design-cli@latest add date-time-picker
```
