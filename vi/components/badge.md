...
```bash [npm]
npx @galaxy-stack/design-cli@latest add badge
```

```bash [pnpm]
pnpm dlx @galaxy-stack/design-cli@latest add badge
```

```bash [yarn]
yarn dlx @galaxy-stack/design-cli@latest add badge
```

```bash [bun]
bunx @galaxy-stack/design-cli@latest add badge
```
