...
```bash [npm]
npx @galaxy-stack/design-cli@latest add checkbox
```

```bash [pnpm]
pnpm dlx @galaxy-stack/design-cli@latest add checkbox
```

```bash [yarn]
yarn dlx @galaxy-stack/design-cli@latest add checkbox
```

```bash [bun]
bunx @galaxy-stack/design-cli@latest add checkbox
```
