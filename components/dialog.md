...
```bash [npm]
npx @galaxy-stack/design-cli@latest add dialog
```

```bash [pnpm]
pnpm dlx @galaxy-stack/design-cli@latest add dialog
```

```bash [yarn]
yarn dlx @galaxy-stack/design-cli@latest add dialog
```

```bash [bun]
bunx @galaxy-stack/design-cli@latest add dialog
```
