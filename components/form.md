...
```bash [npm]
npx @galaxy-stack/design-cli@latest add form
```

```bash [pnpm]
pnpm dlx @galaxy-stack/design-cli@latest add form
```

```bash [yarn]
yarn dlx @galaxy-stack/design-cli@latest add form
```

```bash [bun]
bunx @galaxy-stack/design-cli@latest add form
```
