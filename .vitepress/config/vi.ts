...
export const vi = defineConfig({
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: 'https://github.com/galaxy-nebula/galaxy-design/edit/main/docs/:path',
  ...
  return [
    ...
    },
    {
      ...
      items: [
        {
          text: 'Changelog',
          link: 'https://github.com/galaxy-nebula/galaxy-design/blob/main/CHANGELOG.md',
        },
        {
          text: 'Đóng góp',
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Combobox (Web Only)', link: 'combobox' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Data Table (Web Only)', link: 'data-table' },
